...
public class Place_Order extends AppCompatActivity
    ...
    public void placeOrder_database(final View v)
    {
           ...
           final String n1=NAME;
            ...
            dialog.setPositiveButton("Confirm Order", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    Toast.makeText(Place_Order.this,"Pickup Confirmed.",Toast.LENGTH_SHORT).show();
                    Intent i=new Intent(Place_Order.this,orderConfirmed.class);
                    startActivity(i);
                }
            });
