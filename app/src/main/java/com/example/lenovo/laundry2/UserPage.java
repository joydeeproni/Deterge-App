...
public class UserPage extends AppCompatActivity
    ...
    private TextView textname,hname;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hname=(TextView)findViewById(R.id.helloName) ;
        ...
        ValueEventListener user= new ValueEventListener() {
            ...
            public void onDataChange(com.google.firebase.database.DataSnapshot dataSnapshot) {
                ...
                n=ud.getName();
                if(n.contains(" ")) {
                    int firstSpace = n.indexOf(" "); // detect the first space character
                    n = n.substring(0, firstSpace);
                }
                hname.setText(n);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_rateList) {
            ...
            Intent i1 = new Intent(Intent.ACTION_VIEW, Uri.parse("tel:9124127762"));
            startActivity(i1);

        } else if (id == R.id.email){
            Intent i1 = new Intent(Intent.ACTION_VIEW, Uri.parse("mailto:detergeservice@gmail.com"));
            startActivity(i1);
